export function menu () {
  ...
  navbarInner.setAttribute('id', 'navbar-inner')
  ...
  links.forEach(l => {
    ...
    navbarInner.appendChild(a)
    if (window.location.href.endsWith(l.href)) {
