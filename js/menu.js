...
const html = `
  <div id="navbar">
    <div id="navbar-inner">
      <a href="index.html">
        <svg id="menu-icon-record" viewBox="0,0,512,512" class="menu-icon">
      ...
      <!--
      <a href="list.html">
        <svg id="menu-icon-list" viewBox="0,0,512,512" class="menu-icon">
      ...
      -->
      <a href="options.html">
        <svg id="menu-icon-settings" viewBox="0,0,512,512" class="menu-icon">
