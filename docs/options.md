...
*You should not store your records on your phone for too long.* If your device runs critically low on memory, there is a risk that your device will delete your records to fee up space. Please read the full explanation of this risk on the introductory page [intro](/help.html?page=intro).
